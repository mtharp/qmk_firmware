...
#define STM32_I2C_USE_DMA                   FALSE // conflict with SPI2
...
// Reserve timers so HAL conflicts can be detected
#define STM32_TIM2_IS_USED TRUE
#define STM32_TIM3_IS_USED TRUE
#define STM32_TIM4_IS_USED TRUE
